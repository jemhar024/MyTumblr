...
$acc_username = "JemharJhon";
$acc_password = "jemhar1234";
$acc_fullname = "Jemhar Jhon Logatoc";
$acc_address = "Mahinhin Boac Marinduque";


//chech the url address for redirection
$url_add = "http://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];

//condition if the button is clicked
if(isset($_REQUEST['login_button']) === true){

	//get username and password and compare to predefines username and passsword
	//mali kaagad ang username
		if($_REQUEST['form_username'] != $acc_username){
			echo "Username didnt didnt exist in the system";
